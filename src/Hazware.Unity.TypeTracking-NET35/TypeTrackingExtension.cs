...
namespace Hazware.Unity.TypeTracking
{
  ...
  public class TypeTrackingExtension : UnityContainerExtension
  {
    ...
    private void OnNewType(object sender, RegisterEventArgs e)
    {
      ...
      /* Possible Bug Identified by Allen in Blog Post Comment: http://buksbaum.us/2009/08/20/extending-and-demonstrating-the-type-tracking-extension-for-unity/comment-page-1/#comment-1510
       * Here is Allens Proposed Solution:
      HashSet names;
      string name = string.IsNullOrEmpty(e.Name) ? string.Empty : e.Name;
      if (e.TypeFrom == null)
